...
class Compo03a extends Frame  implements ActionListener, ItemListener 
{
	...
	Compo03a(String titulo, int largura, int altura, int colinic, int lininic) 
	{ 
		super(titulo); 
	...
	{ 
		if (e.getSource() == lst1) 
		{ 
			if (lst1.getSelectedIndex()>-1) l3.setText(lst1.getSelectedItem()); 
		} 
	}
}
